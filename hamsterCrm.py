...
"""
La aplicación Hamster (Sistema para administrar clientes) fue diseñada y desarrollada
por The Informatic Hamster. Sientase libre de usarla.
"""
...
class Ayuda(QDialog):
    def __init__(self, parent=None):
        ...
        self.setWindowTitle("Hamster Ayuda")
    ...
    def initUI(self):
        label = QLabel(self)
        label.setPixmap(QPixmap("Imagenes/hamster.jpeg").scaled(450, 450, Qt.KeepAspectRatio,
...
class Acerca(QDialog):
    def __init__(self, parent=None):
        ...
        self.setWindowTitle("Acerca de Hamster CRM")
        self.setWindowFlags(Qt.WindowTitleHint | Qt.CustomizeWindowHint |
                            Qt.MSWindowsFixedSizeDialogHint)
        self.setFixedSize(450, 500)
    ...
    def initUI(self):
        ...
        labelAcerca = QLabel("HAMSTER CRM: Sistema para administrar clientes, diseñado y \ndesarrollado "
                             "por The Informatic Hamster (TIH).", self)
...
class nuevoCliente(QDialog):
    ...
    def initUI(self):
      ...
      # =========== WIDGETS GROUPBOX DATOS GENERALES =============
        ...
        self.comboBoxSexo.addItems(["Masculino", "Femenino", "No Binarie", "No Responde"])
  ...
  # ========================= FUNCIONES ==========================
    ...
    def Aceptar(self):
        ...
        if not nombre:
            ...
            if QFile.exists("DB_HAMSTER/DB_TIH.db"):
                conexion = sqlite3.connect("DB_HAMSTER/DB-TIH.db")
...
class Configuracion(QDialog):
    ...
    def initUI(self):
        ...
        label = QLabel(frame)
        label.setPixmap(QPixmap("Imagenes/hamster.jpeg").scaled(447, 447, Qt.KeepAspectRatio,
                                                              Qt.SmoothTransformation))
        label.move(1, 1)
  ...
  # ========================= FUNCIONES ==========================
    ...
    def Configuracion(self):
        QMessageBox.information(self, "Configuración", "Este es un mensaje de ejemplo.\n\n16 "
                                "de Junio de 2023: revelación de enigmas y misterios   \na "
                                "todos los Hamsters.", QMessageBox.Ok)
...
class Widgets(QWidget):
    ...
    def initUI(self):
      ...
      # ============================================================
        ...
        paletaPanel.setBrush(QPalette.Background, QBrush(QColor(96, 147, 172), Qt.SolidPattern))
      ...
      # ============================================================
        ...
        paletaSuscribete.setBrush(QPalette.Background, QBrush(QColor(96, 147, 172),
                                                              Qt.SolidPattern))
        ...
        labelSuscribete = QLabel("<a href="
                                 ">Trabajo Integrador</a>", frameBotones)
      ...
      # ============ FRAME BIENVENIDO - CONFIGURACIÓN ==============
        ...
        paletaFrame.setColor(QPalette.Background, QColor("silver"))
      ...
      # ============================================================
        ...
        paletaTitulo.setColor(QPalette.Foreground, Qt.white)

        labelBienvenido = QLabel("BIENVENIDO A HAMSTERS CRM")
  ...
  # ======================= FUNCIONES ============================
    ...
    def Suscribete(self, celda):
        QMessageBox.warning(self, "Saluditos", "Hola, los Hamsters los saludamos desde Cordoba"
                            "\nPor cierto hiciste doble clic sobre esta "
                            "celda: Gracias. ".format(celda.text()), QMessageBox.Ok)
...
class Hamster(QMainWindow):
    def __init__(self, parent=None):
        super(Hamster, self).__init__(parent)

        self.setWindowIcon(QIcon("Imagenes/Qt.png"))
        self.setWindowTitle("HAMSTER CRM (Sistema para administrar clientes por:  The Informatic Hamsters)")
    ...
    def initUI(self):
      ...
      # ========================= MENÚ ===========================
        ...
        siacleMenu = menu.addMenu("&Hamster CRM")
      ...
      # ============== BARRA DE ESTADO (STATUSBAR) ===============
        ...
        labelVersion.setText("HAMSTER CRM versión beta: 1.0  ")
  ...
  # ========================= FUNCIONES ==========================
    ...
    def closeEvent(self, event):
        ...
        cerrar.setWindowTitle("¿Salir de Hamster CRM?")
        cerrar.setIcon(QMessageBox.Question)
        cerrar.setText("¿Estás seguro que desea cerrar Hamster CRM?   ")
