...
"""
El módulo *crearDB* permite crear la Base de Datos de la aplicación HAMSTER CRM.
"""
...
conexion = sqlite3.connect("DB_TIH.db")
...
try:
    ...
    datos_insertar = [("Andres", "Garatea", "Masculino", "06/12/2019", "Colombia", "3104187394"),
                      ...
                      ("Lawrence Edward", "Page", "Masculino", "26/03/1973", "Estados Unidos", "3234187394")]
